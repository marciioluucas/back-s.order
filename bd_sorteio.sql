...
--
-- Host: 127.0.0.1
-- Generation Time: 08-Out-2016 às 16:54
...
ALTER TABLE `propriedades_produto`
  ...
  ADD KEY `fk_tamanho_produto_produto1_idx` (`produto_id`);
...
--
-- Limitadores para a tabela `propriedades_produto`
--
ALTER TABLE `propriedades_produto`
  ADD CONSTRAINT `fk_tamanho_produto_produto1` FOREIGN KEY (`produto_id`) REFERENCES `produto` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
